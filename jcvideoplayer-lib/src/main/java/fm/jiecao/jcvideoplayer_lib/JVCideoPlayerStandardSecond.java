...
public class JVCideoPlayerStandardSecond extends JCVideoPlayer {
    ...
    private SaveVideoDialog savaVideoDialog;
    private String messageId;
    private String orUrl;
    private String userId;
    private boolean enableShare; // 我的收藏打开的情况不显示

    private OnActionListener onActionListener;
    SaveVideoDialog.OnSavaVideoDialogClickListener onSavaVideoDialogClickListener = new SaveVideoDialog.OnSavaVideoDialogClickListener() {
        @Override
        ...
        public void tv2Click() {
            if (onActionListener != null) {
                onActionListener.share(new MessageEventVideo(orUrl));
            }
        }
        ...
        public void tv3Click() {
            if (onActionListener != null) {
                onActionListener.collection(new MessageEventPublic(messageId, orUrl, userId));
            }
        }
    ...
    public void init(final Context context) {
        ...
        findViewById(R.id.gotoanother).setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                savaVideoDialog = new SaveVideoDialog(context, onSavaVideoDialogClickListener);
    ...
    private void downloadUrl(String mVideoPath) {
        //  /storage/emulated/0/Android/data/com.chat.weichat/files/10009550/Music/f2e825871bd648e4ad85c4f09eab5890.mp4
        //  file:///storage/emulated/0/Android/data/com.chat.weichat/cache/video-cache/88b2aaa62a7192a612.mp4
        //  /storage/emulated/0/Android/data/com.chat.weichat/cache/video-cache/88b2aaa62a7192a612.mp4
        File file = new File(Uri.parse(mVideoPath).getPath());
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        switch (objects.length) {
            case 4:
                enableShare = (boolean) objects[3];
            case 3:
                userId = objects[2].toString();
            case 2:
                orUrl = objects[1].toString();
            case 1:
                messageId = objects[0].toString();
        }
...
//        }
    ...
    public interface OnActionListener {
        void share(final MessageEventVideo message);

        void collection(final MessageEventPublic message);
    }
