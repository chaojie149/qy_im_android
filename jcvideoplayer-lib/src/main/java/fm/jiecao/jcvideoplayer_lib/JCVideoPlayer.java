...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener, View.OnLongClickListener {
    ...
    public boolean startWindowFullscreen() {
        ...
        try {
            ...
            if (this instanceof JVCideoPlayerStandardSecond && jcVideoPlayer instanceof JVCideoPlayerStandardSecond) {
                ((JVCideoPlayerStandardSecond) jcVideoPlayer).setOnActionListener(((JVCideoPlayerStandardSecond) this).getOnActionListener());
            }
