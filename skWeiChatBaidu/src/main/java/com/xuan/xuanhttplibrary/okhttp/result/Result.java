...
public class Result {
    ...
    public final static int CODE_LOGIN_TOKEN_INVALID = 1030112;// 自动登录时的loginToken失效，
    public final static int CODE_LOGIN_TOKEN_OVERTIME = 1030113;// 自动登录时的loginToken过期，
    ...
    public final static int CODE_ROOM_GONE = 100411;// 群组已解散，
     ...
     * 用于判断的最后一环，弹出错误提示，
     */
    public static void toastElse(Context context, Result result) {
