...
import com.tongxin.caihong.bean.PayCode;
import com.tongxin.caihong.bean.PayPrivateKey;
import com.tongxin.caihong.sp.UserSp;
import com.tongxin.caihong.ui.base.CoreManager;
import com.tongxin.caihong.ui.me.redpacket.PayPasswordVerifyDialog;
...
import com.tongxin.caihong.util.secure.PayPassword;
...
public class PaySecureHelper {
            ...
            getCode(ctx, coreManager, key, t -> {
                ...
                getRsaPrivateKey(ctx, coreManager, key, t -> {
                    ...
                    public void apply(byte[] privateKey) {
                        ...
                        String mac = RSA.signBase64(AppConfig.getApiKey() + coreManager.getSelf().getUserId() + UserSp.getInstance(ctx).getAccessToken() + valueString + time + payPasswordMd5, privateKey);
    ...
    private static void getCode(Context ctx, CoreManager coreManager, byte[] key, Function<Throwable> onError, Function2<String, String> onSuccess) {
        ...
        String mac = MAC.encodeBase64((AppConfig.getApiKey() + coreManager.getSelf().getUserId() + UserSp.getInstance(ctx).getAccessToken() + salt).getBytes(), payPasswordMd5);
