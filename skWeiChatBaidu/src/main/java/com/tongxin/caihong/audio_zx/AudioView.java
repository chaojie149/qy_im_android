package com.tongxin.caihong.audio_zx;
...
//        }
    ...
    public void fillData(ChatMessage chatMessage) {
        bindData(
                ...
                UploadCacheUtils.get(mContext, chatMessage),
        ...
        if (!file.exists()) {
            Downloader.getInstance().addDownload(content, new DownloadListener() {
                ...
                public void onComplete(String uri, String filePath, View view) {
                    ...
                    } else if (VoiceManager.instance().getState() == com.tongxin.caihong.audio_x.VoiceManager.STATE_PLAY && TextUtils.equals(path, VoiceManager.instance().mCurrtPath)) {
                        startAnim(durationAni, null, false);
            ...
            isDown = true;
            if (VoiceManager.instance().getState() == com.tongxin.caihong.audio_x.VoiceManager.STATE_PLAY && TextUtils.equals(path, VoiceManager.instance().mCurrtPath)) {
                startAnim(durationAni, null, false);
                VoicePlayer.instance().changeVoice(AudioView.this);
            }
        }
...
//                startAnim(viewO);
    ...
    public void stop() {
        if (VoiceManager.instance().getState() == com.tongxin.caihong.audio_x.VoiceManager.STATE_PLAY) {
