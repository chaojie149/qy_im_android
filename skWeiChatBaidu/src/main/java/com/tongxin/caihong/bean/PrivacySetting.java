...
public class PrivacySetting {
    ...
    public int getBeInvitedJoinRoom() {
        return beInvitedJoinRoom;
    }

    public void setBeInvitedJoinRoom(int beInvitedJoinRoom) {
        this.beInvitedJoinRoom = beInvitedJoinRoom;
    }
    ...
    public void setAllowLocation(int allowLocation) {
