...
public class OpenRedpacket implements Serializable {
    ...
    public class PacketEntity implements Serializable {
        ...
        private String uPayRedPacketId;
        ...
        public String getuPayRedPacketId() {
            return uPayRedPacketId;
        }

        public void setuPayRedPacketId(String uPayRedPacketId) {
            this.uPayRedPacketId = uPayRedPacketId;
        }
    }
