...
public class Friend implements Serializable {
    ...
    public static final String ID_SYSTEM_COLLEAGUE_NOTIFICATION = "999";// 系统号，我的同事功能相关消息通知
    ...
    public static final int STATUS_24 = 24;//被移除黑名单
    ...
    public static final int STATUS_27 = 27;//把对方移除黑名单
    private static final long serialVersionUID = -6859528031175998594L;
    @DatabaseField(generatedId = true)
    private int _id;

    @DatabaseField(canBeNull = false, uniqueIndex = true, uniqueIndexName = "index_id")
    ...
    // 这个字段目前没有其它地方使用，又不太想给Friend表加一个字段，暂时拿他来存放消息id，将friend与其最后一条消息关联起来
    @DatabaseField
    ...
    @DatabaseField
    private int roomRole;// 我在群里的身份，以便群组页查询，

    @DatabaseField(defaultValue = "0")
    private long topTime;
    // 0:正常 1:被踢出该群组 2:该群已被解散 3:该群已被后台锁定 4:我在群组中被拉黑
    @DatabaseField(defaultValue = "0")
    ...
    @DatabaseField
    private long joinSeqNo;// 加入群组时该群组在服务器上消息的最大序号
    @DatabaseField
    private boolean isService;// 是否是客服，
    @DatabaseField
    ...
    public long getJoinSeqNo() {
        return joinSeqNo;
    }

    public void setJoinSeqNo(long joinSeqNo) {
    ...
    public void setHideChatSwitch(int hideChatSwitch) {
    ...
    public int getIsSendRead() {
        return isSendRead;
    }

    public void setIsSendRead(int isSendRead) {
