...
public class AttentionUser {
    ...
    private int isSendMsgState = 1; // 是否发送已读回执，  1：开启 0：关闭
    ...
    public int getIsSendMsgState() {
        return isSendMsgState;
    }

    public void setIsSendMsgState(int isSendMsgState) {
        this.isSendMsgState = isSendMsgState;
    }
}
