...
public class Companys {
    ...
    private String deleteUserId;       // 删除ID
    ...
    // 是否加入了公司，0 否 1 是
    private int currentUserIsExist;
    // 用户主动加入公司是否需要创建者确认 0 否 1 是
    private int userJoinCompanyIsNeedManagerConfirm;
    ...
    public int getCurrentUserIsExist() {
        return currentUserIsExist;
    }

    public void setCurrentUserIsExist(int currentUserIsExist) {
        this.currentUserIsExist = currentUserIsExist;
    }

    public int getUserJoinCompanyIsNeedManagerConfirm() {
        return userJoinCompanyIsNeedManagerConfirm;
    }

    public void setUserJoinCompanyIsNeedManagerConfirm(int userJoinCompanyIsNeedManagerConfirm) {
        this.userJoinCompanyIsNeedManagerConfirm = userJoinCompanyIsNeedManagerConfirm;
    }
}
