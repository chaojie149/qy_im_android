...
import com.tongxin.caihong.luo.camfilter.CameraEngine;
import com.tongxin.caihong.luo.camfilter.LuoGPUCameraInputFilter;
...
import com.tongxin.caihong.video.MessagePhoto;
...
public class LuoGLCameraView extends LuoGLBaseView {
    ...
    @Override
    public void onSurfaceChanged(GL10 gl, int width, int height) {//如果表面发生改变，则先通知基类，基类云善绘知各个过滤器大小变化了。然后打开相机。
