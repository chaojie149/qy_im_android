package com.tongxin.caihong.audio_x;

import static com.tongxin.caihong.audio_x.VoiceManager.STATE_PLAY;
...
public class VoicePlayer {
    ...
    public void removeVoicePlayListener(VoiceManager.VoicePlayListener listener) {
