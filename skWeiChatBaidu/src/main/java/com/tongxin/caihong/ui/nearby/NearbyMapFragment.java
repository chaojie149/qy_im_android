...
import com.tongxin.caihong.adapter.MarkerPagerAdapter;
        ...
        if (createView) {
            ...
            daohang.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    bottomDialog.show();
                    bottomDialog.findViewById(R.id.tvCancel).setOnClickListener(view1 -> bottomDialog.dismiss());
                    bottomDialog.findViewById(R.id.bdmap).setOnClickListener(view12 -> {
                    ...
                    bottomDialog.findViewById(R.id.gdmap).setOnClickListener(view13 -> {
                    ...
                    bottomDialog.findViewById(R.id.ggmap).setOnClickListener(view14 -> {
    ...
    class NearbyCardAdapter extends MarkerPagerAdapter {
        ...
        public View getView(View convertView, final int position) {
            ...
            if (convertView == null) {
                ...
                viewHolder.tvDistant = convertView.findViewById(R.id.tvDistant);
            ...
            viewHolder.tvDistant.setText(distance);
