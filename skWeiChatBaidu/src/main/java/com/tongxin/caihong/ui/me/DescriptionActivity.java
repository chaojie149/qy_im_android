...
public class DescriptionActivity extends BaseActivity {
    ...
    private void initActionBar() {
        ...
        tv_title_right.setOnClickListener(v -> {
            ...
            if (TextUtils.equals(coreManager.getSelf().getDescription(), description)) {
                finish();
            } else {
    ...
    private void initView() {
        ...
        String defaultDesc = coreManager.getSelf().getDescription();
        if (!TextUtils.isEmpty(defaultDesc)) {
            et_desc.setText(defaultDesc);
            et_desc.setSelection(defaultDesc.length());
        }
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        if (Result.checkSuccess(mContext, result)) {
                            coreManager.getSelf().setDescription(description);
