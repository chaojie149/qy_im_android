...
import com.tongxin.caihong.audio.RecordStateListener;
...
import com.tongxin.caihong.audio.RecordManager;
...
public class JsSdkInterface {
        ...
        if (recordManager == null) {
            synchronized (this) {
                if (recordManager == null) {
                    ...
                    myRecordStatusListener = new MyRecordStatusListener();
                    recordManager.addVoiceVolumeListener(myRecordStatusListener);
                }
            }
        }
    ...
    public void release() {
        if (recordManager != null) {
            recordManager.removeVoiceVolumeListener(myRecordStatusListener);
