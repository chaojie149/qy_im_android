...
import com.tongxin.caihong.bean.redpacket.RedListItemRecive;
import com.tongxin.caihong.bean.redpacket.RedListItemSend;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (adapterType == 0) {
                ...
                switch (sendRedList.get(position).getType()) {
                    ...
                    break;
                    case 2: {
                        redViewHolder.userNameTv.setText(getString(R.string.red_random));
                    }
                    break;
                    case 3: {
