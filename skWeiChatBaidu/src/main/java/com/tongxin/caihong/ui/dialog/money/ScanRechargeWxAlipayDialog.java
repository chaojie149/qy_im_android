package com.tongxin.caihong.ui.dialog.money;
...
public class ScanRechargeWxAlipayDialog extends Dialog {
    ...
    private void recharge() {
        String payName = etPayName.getText().toString().trim();
        if (TextUtils.isEmpty(payName)) {
            ToastUtil.showToast(mContext, mContext.getResources().getString(R.string.not_pay_name));
            return;
        }
