...
public class SelectCoverDialog extends Dialog implements View.OnClickListener {
    ...
    private com.tongxin.caihong.ui.xrce.Xcoverbar mCoverBar;
    private com.tongxin.caihong.ui.xrce.Xcoverbar.OnChangeListener mListener;

    public SelectCoverDialog(Context context, com.tongxin.caihong.ui.xrce.Xcoverbar.OnChangeListener listener) {
    ...
    private void initView() {
        ...
        mCoverBar.addOnChangeListener(new com.tongxin.caihong.ui.xrce.Xcoverbar.OnChangeListener() {
            @Override
