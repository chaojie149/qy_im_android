...
public class TowInputDialogView extends BaseDialog {
    ...
    protected void initView() {
        ...
        mContentEt.setFilters(new InputFilter[]{DialogHelper.mExpressionFilter});
        mSecondEt = (AutoCompleteTextView) mView.findViewById(R.id.second_et);
        mSecondEt.setFilters(new InputFilter[]{DialogHelper.mExpressionFilter});
        ...
        //2023/11/30 注释隐藏私密群组
        mView.findViewById(R.id.secret_group_rl).setVisibility(View.GONE);
        ...
        mView.findViewById(R.id.ivClose).setOnClickListener(view -> dismiss());
    }
