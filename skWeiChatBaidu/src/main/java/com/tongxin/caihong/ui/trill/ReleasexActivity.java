...
import com.tongxin.caihong.ui.circle.range.SelectCoverActivity;
...
public class ReleasexActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_label: // 选择标签
                Intent intent3 = new Intent(this, com.tongxin.caihong.ui.trill.TagPickerActivity.class);
    ...
    private String tagToName(int tag) {
        switch (tag) {
            ...
            case 900:
                return getString(R.string.save_failed1);
        }
        return getString(R.string.other);
    }
