...
public class ResetPayPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (coreManager.getSelf() != null && !TextUtils.isEmpty(coreManager.getSelf().getTelephoneNoAreaCode())) {
...
//                }
    ...
    private void resetPassword() {
        ...
        final String digestPwd = LoginPassword.encodeMd5(authCode);
        byte[] smsKey = MD5.encrypt(digestPwd);
