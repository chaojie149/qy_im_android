...
import com.tongxin.im.audio.MessageEventVoice;
import com.tongxin.im.audio.VoicePlayer;
import com.tongxin.im.audio.VoiceRecordActivity2;
...
import com.tongxin.caihong.view.SendAudioDialog;
        ...
        mFloatLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(mAudioFilePath)) {
                    ...
                    SendAudioDialog sendAudioDialog = new SendAudioDialog(mContext, new SendAudioDialog.OnSendAudioItemListener() {
                        @Override
                        public void tvPlay() {
                            if (voicePlayer == null) {
                            ...
                            voicePlayer.stop();
                            voicePlayer.play(mAudioFilePath);
                        }

                        @Override
                        public void tvRecordAgain() {
                            Intent intent = new Intent(SendAudioActivity.this, VoiceRecordActivity2.class);
                            startActivity(intent);
                        }
                    });
