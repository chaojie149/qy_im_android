...
public class LiveConstants {
     ...
     */
    public static String LIVE_MEMBER_ADD = "live_member_add";          // 直播间列表刷新
    public static String LIVE_MEMBER_DELETE = "live_member_delete";    // 直播间列表刷新
    public static String LIVE_DANMU_DRAWABLE = "live_danmu_drawable";  // 绘制弹幕
    public static String LIVE_SEND_GIFT = "live_send_gift";            // 发送礼物
    public static String LIVE_SEND_LOVE_HEART = "live_send_love_heart";// 发送爱心
    public static String LIVE_SEND_MANAGER = "live_send_manager";      // 设为管理员
    public static String LIVE_SEND_SHUT_UP = "live_send_shut_up";      // 禁言
    public static String LIVE_SEND_LOCKED = "live_is_locked";          // 锁定直播间
    public static String LIVE_SEND_REFRESH_MONEY = "live_send_refresh_money";// 刷新余额
}
