...
import com.tongxin.caihong.view.AllowTypeDialog;
import com.tongxin.caihong.view.MsgSyncDaysDialog;
...
public class PrivacySettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    // 邀我进群需要验证
    private SwitchButton sbInviteJoinRoomNeedVerify;
    private SwitchButton sbHiding;
    private SwitchButton mSbAllowUploadLocation;
        ...
        public void onCheckedChanged(SwitchButton view, boolean isChecked) {
            switch (view.getId()) {
                ...
                case R.id.mSbSlideClearServer:
                    ...
                    break;
                case R.id.sbInviteJoinRoomNeedVerify:
                    submitPrivacySetting(14, isChecked);
                    break;
                case R.id.sbHiding:
                    submitPrivacySetting(15, isChecked);
                    break;
                case R.id.mSbAllowUploadLocation:
                    submitPrivacySetting(16, isChecked);
                    break;
            }
        }
    };
    ...
    private void initView() {
        ...
        findViewById(R.id.rl_allow_upload_location).setVisibility(!coreManager.getConfig().disableLocationServer ? View.VISIBLE : View.GONE);
        ...
        //新增隐藏 设置通过昵称搜索到我
        //findViewById(R.id.allow_sbNameSearch_rl).setVisibility(View.GONE);
        sbInviteJoinRoomNeedVerify = (SwitchButton) findViewById(R.id.sbInviteJoinRoomNeedVerify);
        sbHiding = (SwitchButton) findViewById(R.id.sbHiding);
        mSbAllowUploadLocation = (SwitchButton) findViewById(R.id.mSbAllowUploadLocation);
    ...
    private void initStatus() {
        ...
        sbInviteJoinRoomNeedVerify.setChecked(privacySetting.getBeInvitedJoinRoom() == 1);
        sbHiding.setChecked(privacySetting.getHiding() == 1);
        mSbAllowUploadLocation.setChecked(privacySetting.getAllowLocation() == 1);
        ...
        mSbSupport.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                sbInviteJoinRoomNeedVerify.setOnCheckedChangeListener(onCheckedChangeListener);
                sbHiding.setOnCheckedChangeListener(onCheckedChangeListener);
                ...
                mSbAllowUploadLocation.setOnCheckedChangeListener(onCheckedChangeListener);
    ...
    private void submitPrivacySetting(final int index, final boolean isChecked) {
        ...
        if (index == 1) {
            ...
            params.put("beInvitedJoinRoom", status);
        } else if (index == 15) {
            params.put("hiding", status);
        } else if (index == 16) {
            params.put("allowLocation", status);
        }
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (Result.checkSuccess(PrivacySettingActivity.this, result)) {
                            ...
                            if (index == 2) {
                                ...
                                privacySetting.setBeInvitedJoinRoom(value);
                            } else if (index == 15) {
                                privacySetting.setHiding(value);
                                PreferenceUtils.putInt(MyApplication.getContext(), Constants.SELF_REAL_HIDING, value);
                            } else if (index == 16) {
                                privacySetting.setAllowLocation(value);
                            }
                            PrivacySettingHelper.setPrivacySettings(PrivacySettingActivity.this, privacySetting);
                        }
                    }
    ...
    private void setSwitchButtonEnableTouch(int type, boolean enableTouch) {
        if (type == 1) {
            ...
            sbInviteJoinRoomNeedVerify.setEnableTouch(enableTouch);
        } else if (type == 15) {
            sbHiding.setEnableTouch(enableTouch);
        } else if (type == 16) {
            mSbAllowUploadLocation.setEnableTouch(enableTouch);
        }
    }
