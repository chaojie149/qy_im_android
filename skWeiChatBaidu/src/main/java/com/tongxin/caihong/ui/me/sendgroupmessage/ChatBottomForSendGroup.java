...
import com.tongxin.caihong.view.ChatFaceView;

import java.util.ArrayList;

import static com.tongxin.caihong.view.ChatBottomView.LIMIT_MESSAGE_LENGTH;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.im_file_tv:
                ...
                break;
            case R.id.im_collection_tv:
                // 收藏
                if (mBottomListener != null) {
                    mBottomListener.clickCollection();
                }
                break;
        }
    }
