...
import com.tongxin.caihong.bean.SKLoginBean;
import com.tongxin.caihong.bean.SKLoginResultBean;
...
public class AuthorizationActivity extends BaseActivity {
    ...
    private void verificationLogin() {
        ...
        String secret = Md5Util.toMD5(AppConfig.getApiKey() + mSKLoginBean.getAppId() + coreManager.getSelf().getUserId() +
    ...
    private void loginResult(String userId) {
        ...
        intent.putExtra(ShareConstant.EXTRA_RESULT_TYPE, 0);
