...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        custom_collection = a.getBoolean(
                R.styleable.stl_SmartTabLayout_stl_custom_collection, false);
        a.recycle();
    ...
    private void setCollectionTabView() {
        tabProvider = new CollectionTabProvider(getContext());
    }
    ...
    public void setCollectionTabCheckedChanged(int sum, int count) {
        for (int i = 0; i < sum; i++) {
            View view = this.getTabAt(i);
            TextView tabTitleTextView = view.findViewById(R.id.tvCollectionDesc);
            View tabSelectView = view.findViewById(R.id.vCollectionDesc);
            ButtonColorChange.rechargeChange(getContext(), tabSelectView, R.drawable.a_bg_for_collection_select);
            if (i == count) {
                ButtonColorChange.textChange(getContext(), tabTitleTextView);
                tabSelectView.setVisibility(VISIBLE);
            } else {
                tabTitleTextView.setTextColor(getResources().getColor(R.color.text_color));
                tabSelectView.setVisibility(GONE);
            }
        }
    }
    ...
    private static class CollectionTabProvider implements TabProvider {

        private final LayoutInflater inflater;
        private Context context;

        private CollectionTabProvider(Context context) {
        ...
        public View createTabView(ViewGroup container, int position, PagerAdapter adapter) {
            View tabView = inflater.inflate(R.layout.gain_tab_collection, container, false);
            if (tabView != null) {
                TextView tabTitleTextView = tabView.findViewById(R.id.tvCollectionDesc);
                if (position == 0) {
                    tabTitleTextView.setText(context.getString(R.string.all));
                } else if (position == 1) {
                    tabTitleTextView.setText(context.getString(R.string.pictures));
                } else if (position == 2) {
                    tabTitleTextView.setText(context.getString(R.string.s_video));
                } else if (position == 3) {
                    tabTitleTextView.setText(context.getString(R.string.s_file));
                } else if (position == 4) {
                    tabTitleTextView.setText(context.getString(R.string.voice));
                } else if (position == 5) {
                    tabTitleTextView.setText(context.getString(R.string.word));
                } else if (position == 6) {
                    tabTitleTextView.setText(context.getString(R.string.s_link));
                }
            }
            return tabView;
        }
