...
import com.tongxin.caihong.view.MulFileDeleteSelectionFrame;
...
import static com.tongxin.caihong.ui.mucfile.DownManager.STATE_DOWNLOADING;
import static com.tongxin.caihong.ui.mucfile.DownManager.STATE_PAUSEDOWNLOAD;
    ...
    private void initActionBar() {
        ...
        ivRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Friend friend = FriendDao.getInstance().getMucFriendByRoomId(coreManager.getSelf().getUserId(), mRoomId);
                if (friend != null) {
                    mAllowUploadFile = PreferenceUtils.getBoolean(mContext
                            , Constants.IS_ALLOW_NORMAL_SEND_UPLOAD + friend.getUserId()
                            , true) ? 1 : 0;
                }
                if (mAllowUploadFile == 1 || mRole == 1 || mRole == 2) {
                    ...
                    AddMucFileActivity.start(MucFileListActivity.this, REQUEST_CODE_UPLOAD
                            , mRole
                            , friend != null ? friend.getUserId() : ""
                            , mRoomId);
                } else {
