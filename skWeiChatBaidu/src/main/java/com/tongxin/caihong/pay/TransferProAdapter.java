...
public class TransferProAdapter extends RecyclerView.Adapter {
    ...
    private List<TransferRecord.PageDataBean> mTransfers;

    public TransferProAdapter(Context context, List<TransferRecord.PageDataBean> transfers) {
    ...
    class HeadViewHolder extends BaseRecViewHolder {
        ...
        public void onBind(List<TransferRecord.PageDataBean> list, int position) {
            TransferRecord.PageDataBean bean = list.get(position);
