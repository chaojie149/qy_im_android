...
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_EXIT_VOICE;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_FILE;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_IMAGE;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_IS_CONNECT_VOICE;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_RED;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_TEXT;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_TRANSFER;
import static com.tongxin.caihong.bean.message.XmppMessage.TYPE_VIDEO;
