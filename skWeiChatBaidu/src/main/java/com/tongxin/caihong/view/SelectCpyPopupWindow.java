...
public class SelectCpyPopupWindow extends PopupWindow {
    ...
    public SelectCpyPopupWindow(Context context, OnClickListener itemsOnClick) {
        super(context);
        ...
        mSearchCompany = (Button) mMenuView.findViewById(R.id.btn_search_company);

        //设置按钮监听
        mCreateCompany.setOnClickListener(itemsOnClick);
        mSearchCompany.setOnClickListener(view -> {
            SearchCompanyActivity.start(context);
            dismiss();
        });
