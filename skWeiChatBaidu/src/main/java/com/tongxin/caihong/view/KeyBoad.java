                ...
                public void onClick(View v) {
                    ...
                    if (curSelection < length) {
                        ...
                        if (!content.substring(0, curSelection).endsWith(".")) {
                            if (content.startsWith(String.valueOf(0)) && TextUtils.equals(button.getText(), String.valueOf(0))) {
                                ToastUtil.showToast(context, context.getString(R.string.illegal_input));
                                return;
                            }
                            if (curSelection == 0 && content.contains(".") && TextUtils.equals(button.getText(), String.valueOf(0))) {
                                ToastUtil.showToast(context, context.getString(R.string.illegal_input));
                                return;
                            }
                            ...
                            try {
                                ...
                                // java.lang.IndexOutOfBoundsException: setSpan (9 ... 9) ends beyond length 1
                            }
                        }
                    } else {
                        String content = editText.getText().toString();
