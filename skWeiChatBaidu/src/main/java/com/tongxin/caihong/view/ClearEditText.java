...
public class ClearEditText extends InputLimitEditText implements OnFocusChangeListener {
    /**
     * 删除按钮的引用
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (getCompoundDrawables()[2] != null) {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                boolean touchable = event.getX() > (getWidth() - getPaddingRight() - getClearDrawable().getIntrinsicWidth())
