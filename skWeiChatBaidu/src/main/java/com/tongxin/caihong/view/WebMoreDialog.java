...
public class WebMoreDialog extends Dialog {
    ...
    public static WebMoreDialog createSupportFloating(Context context, String url, boolean isFloating, BrowserActionClickListener browserActionClickListener) {
        WebMoreDialog ret = new WebMoreDialog(context, url, browserActionClickListener);
        ret.mContent = context;
        ret.mUrl = url;
        ret.isFloating = isFloating;
        ret.mBrowserActionClickListener = browserActionClickListener;
        ret.mData = ret.getData();
        return ret;
    }
    ...
    private List<Item> getData() {
        if (isHideFloatWindow) {
            return Arrays.asList(
                    ...
                    new Item(R.drawable.ic_bz, R.string.bz, () -> {
                        if (mBrowserActionClickListener != null) {
                            dismiss();
                            mBrowserActionClickListener.edit();
                        }
                    }),
            ...
            return Arrays.asList(
                    new Item(!isFloating ? R.mipmap.floating_window : R.mipmap.floating_window_icon,
                            !isFloating ? R.string.floating_window : R.string.floating_window_cancel, () -> {
                        if (mBrowserActionClickListener != null) {
                            dismiss();
