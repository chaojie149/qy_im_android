...
import static com.tongxin.caihong.R.id.tv_group;
...
public class SelectFileActivity extends BaseActivity {
    ...
    private static OptionFileListener mFileListener;
    ...
    public static void start(Context context, OptionFileListener listener) {
        if (!PermissionUtil.checkAndAutoRequestPermission((AppCompatActivity) context, Short.MAX_VALUE, () -> {
            start(context, listener);
        }, null, PermissionUtil.getStoragePermissions())) {
            return;
        }
        SelectFileActivity.mFileListener = listener;
        Intent starter = new Intent(context, SelectFileActivity.class);
        context.startActivity(starter);
    }

    public static void startSingleChoice(Context context, OptionFileListener listener) {
        if (!PermissionUtil.checkAndAutoRequestPermission((AppCompatActivity) context, Short.MAX_VALUE, () -> {
            start(context, listener);
        }, null, PermissionUtil.getStoragePermissions())) {
            return;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maxOpt = getIntent().getIntExtra("maxOpt", maxOpt);
    ...
    private void initView() {
        ...
        ButtonColorChange.colorChange(mContext, mBtn);
