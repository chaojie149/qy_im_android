package com.tongxin.caihong.util.input;
...
public class KeyboardPanelUtil {
    ...
    public static SoftKeyBoardListener setKeyboardListener(Window window) {
        return SoftKeyBoardListener.setListener(window);
    }
