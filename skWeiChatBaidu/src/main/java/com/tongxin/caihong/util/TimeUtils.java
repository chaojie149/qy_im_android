...
public class TimeUtils {
    ...
    public static long sk_time_current_time() {
        // 加上与服务器时间差值，
        long timeDifference = PreferenceUtils.getLong(MyApplication.getContext(), Constants.KEY_TIME_DIFFERENCE, 0L);
    ...
    public static void responseTime(long t1, long t2, long t3, long t4) {
        ...
        PreferenceUtils.putLong(MyApplication.getContext(), Constants.KEY_TIME_DIFFERENCE, timeDifference);
    }
