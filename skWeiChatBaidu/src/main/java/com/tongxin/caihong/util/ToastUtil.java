...
public class ToastUtil {
    ...
    public static void showNetError(Context context, Throwable e) {
        if (context == null) {
            return;
        }
        realShowToast(context, context.getString(R.string.request_exception) + ":" + e.getMessage(), Toast.LENGTH_SHORT);
    }
