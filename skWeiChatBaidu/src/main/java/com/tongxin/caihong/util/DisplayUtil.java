...
public class DisplayUtil {
    ...
    public static String getDistance(double latitude, double longitude, User data) {
        ...
        return getDistance(latitude, longitude, sLat, sLng);
    }

    public static String getDistance(double latitude, double longitude, double sLat, double sLng) {
    ...
    public static String getDistanceRoom(double latitude, double longitude, NearRoomItemBean data) {
        String value = ""; // 国际化
        String met = "m"; // 国际化
