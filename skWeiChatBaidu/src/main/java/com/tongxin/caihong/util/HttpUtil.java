...
public class HttpUtil {
    public static final String REGEX_URL = "(((http(s?))\\:\\/\\/)([a-zA-Z0-9\\-]{1,63})(\\.[a-zA-Z0-9\\-]{1,63})+|([a-zA-Z0-9\\-]{1,63}\\.)+(com|cn|cc|top|xyz|edu|gov|mil|net|org|biz|info|name|museum|us|ca|uk|co))(\\:\\d+)?(\\/([a-zA-Z0-9_\\-\\.~!*\\'()\\;\\:@&=+&$,/?#%]*))*";
