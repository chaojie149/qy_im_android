...
-keep class com.tongxin.caihong.activity.** {*;}
...
-keep class com.tongxin.caihong.util.SkinUtils.Skin { *; }
-keep class com.tongxin.caihong.socket.** { *; }
-keep class com.tongxin.caihong.bean.** { *; }
-keep class com.tongxin.caihong.ui.live.bean.** { *; }
-keep class com.tongxin.caihong.ui.mucfile.bean.** { *; }
-keep class com.tongxin.caihong.service.bean.** { *; }
-keep class com.tongxin.caihong.view.verificationcodejavademo.** { *; }
...
-keep class com.tongxin.caihong.ui.me.redpacket.alipay.** { *; }
-keep class com.alipay.android.app.IAlixPay{*;}
-keep class com.alipay.android.app.IAlixPay$Stub{*;}
-keep class com.alipay.android.app.IRemoteServiceCallback{*;}
-keep class com.alipay.android.app.IRemoteServiceCallback$Stub{*;}
...
# 阿里云本机号码一键登录，https://help.aliyun.com/document_detail/144231.html?spm=a2c4g.11186623.6.557.58dd7861trJScF
...
# 阿里云实人认证，https://help.aliyun.com/document_detail/128362.htm
# 官方文档混淆配置出现空指针崩溃，所以扩大了keep范围，
# java.lang.NullPointerException: Attempt to read from field 'android.webkit.WebSettings com.alibaba.security.cloud.build.bs$a.b' on a null object reference
-keep class com.taobao.**{*;}
-keep class com.ut.secbody.**{*;}
-keep class com.alibaba.**{*;}
-keep class android.taobao.**{*;}

# 裁剪库混淆配置，https://github.com/Yalantis/uCrop
-dontwarn com.yalantis.ucrop**
-keep class com.yalantis.ucrop** { *; }
-keep interface com.yalantis.ucrop** { *; }

# BannerViewPager, https://github.com/zhpanvip/BannerViewPager/blob/master/README_CN.md
-keep class androidx.recyclerview.widget.**{*;}
-keep class androidx.viewpager2.widget.**{*;}

# AkDanmaku, https://github.com/KwaiAppTeam/AkDanmaku/blob/master/docs/Guide.md
